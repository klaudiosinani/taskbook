...
const red = chalk.red; // Red bold text
...
Taskbook.prototype.createTask = function (description) {
  ...
  // Clean-up task description from whitespaces
...
Taskbook.prototype.createNote = function (body) {
  ...
  // Clean-up note body from whitespaces
...
Taskbook.prototype.search = function (id) {
  ...
  console.log('\n', red('✖'), 'Unable to find input ID:', id);
  process.exit(1);
};
...
Taskbook.prototype.validateID = function (id) {
  ...
  console.log('\n', red('✖'), 'Invalid input ID:', id);
  process.exit(1);
};

Taskbook.prototype.delete = function (id) {
